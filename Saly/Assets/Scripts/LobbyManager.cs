...
public class LobbiesList : MonoBehaviourPunCallbacks
{
    ...
    public void OnCreateRoomClicked()
    {
        ...
        {
            Debug.LogWarning("⚠ Photon is not ready yet. Wait for OnConnectedToMaster.");
            return;
        }
        ...
        {
            Debug.LogWarning("⚠ You're not in the lobby yet! Wait until OnJoinedLobby is triggered.");
            return;
        }
